...
def _comma_separated_list(env_key: str) -> List[str]:
    s = (os.getenv(env_key) or "").strip()
    if not s:
        return []
    return [p.strip() for p in s.split(",") if p.strip()]


# JSM «Чат-бот по базам знаний» (AA), см. AA-83271 — requestTypeId и customfield_* задать в .env по вашей Jira.
JIRA_AA_KB_CHATBOT_REQUEST_TYPE_ID = (os.getenv("JIRA_AA_KB_CHATBOT_REQUEST_TYPE_ID") or "").strip()
JIRA_AA_KB_CHATBOT_SERVICE_DESK_ID = (
    os.getenv("JIRA_AA_KB_CHATBOT_SERVICE_DESK_ID") or JIRA_AA_SERVICE_DESK_ID
).strip()
JIRA_AA_KB_CHATBOT_SUMMARY = (os.getenv("JIRA_AA_KB_CHATBOT_SUMMARY") or "Чат-бот по базам знаний").strip()
JIRA_AA_KB_CHATBOT_FIELD_FULL_NAME = (os.getenv("JIRA_AA_KB_CHATBOT_FIELD_FULL_NAME") or "").strip()
JIRA_AA_KB_CHATBOT_FIELD_POSITION = (os.getenv("JIRA_AA_KB_CHATBOT_FIELD_POSITION") or "").strip()
JIRA_AA_KB_CHATBOT_FIELD_EDIT_TYPE_CANDIDATES = _comma_separated_list("JIRA_AA_KB_CHATBOT_FIELD_EDIT_TYPE_CANDIDATES")
JIRA_AA_KB_CHATBOT_FIELD_AA_CHATBOT = (os.getenv("JIRA_AA_KB_CHATBOT_FIELD_AA_CHATBOT") or "").strip()
JIRA_AA_KB_CHATBOT_FIELD_REQUEST_TYPE_SELECT = (os.getenv("JIRA_AA_KB_CHATBOT_FIELD_REQUEST_TYPE_SELECT") or "").strip()
# В JSM это чекбокс «Нужно» у сервиса AA Chatbot (см. AA-83271); при пустом env подставляем подпись по умолчанию.
JIRA_AA_KB_CHATBOT_AA_CHATBOT_OPTION_LABEL = (os.getenv("JIRA_AA_KB_CHATBOT_AA_CHATBOT_OPTION_LABEL") or "Нужно").strip()
JIRA_AA_KB_CHATBOT_REQUEST_TYPE_OPTION_LABEL = (os.getenv("JIRA_AA_KB_CHATBOT_REQUEST_TYPE_OPTION_LABEL") or "").strip()
JIRA_AA_KB_CHATBOT_EDIT_OPTION_CREATE = (os.getenv("JIRA_AA_KB_CHATBOT_EDIT_OPTION_CREATE") or "Создать").strip()
JIRA_AA_KB_CHATBOT_EDIT_OPTION_EDIT = (os.getenv("JIRA_AA_KB_CHATBOT_EDIT_OPTION_EDIT") or "Редактировать").strip()

# JSM «Доступ к корпоративной почте через браузер» (AA), тот же request type что и чат-бот, см. AA-83381
JIRA_AA_MAIL_BROWSER_SERVICE_DESK_ID = (
    os.getenv("JIRA_AA_MAIL_BROWSER_SERVICE_DESK_ID") or JIRA_AA_KB_CHATBOT_SERVICE_DESK_ID
).strip()
JIRA_AA_MAIL_BROWSER_REQUEST_TYPE_ID = (
    os.getenv("JIRA_AA_MAIL_BROWSER_REQUEST_TYPE_ID") or JIRA_AA_KB_CHATBOT_REQUEST_TYPE_ID
).strip()
JIRA_AA_MAIL_BROWSER_SUMMARY = (
    os.getenv("JIRA_AA_MAIL_BROWSER_SUMMARY") or "Доступ к корпоративной почте через браузер"
).strip()
JIRA_AA_MAIL_BROWSER_FIELD_FULL_NAME = (
    os.getenv("JIRA_AA_MAIL_BROWSER_FIELD_FULL_NAME") or JIRA_AA_KB_CHATBOT_FIELD_FULL_NAME
).strip()
JIRA_AA_MAIL_BROWSER_FIELD_POSITION = (
    os.getenv("JIRA_AA_MAIL_BROWSER_FIELD_POSITION") or JIRA_AA_KB_CHATBOT_FIELD_POSITION
).strip()
_JIRA_AA_MAIL_BROWSER_EDIT_CAND_ENV = _comma_separated_list("JIRA_AA_MAIL_BROWSER_FIELD_EDIT_TYPE_CANDIDATES")
JIRA_AA_MAIL_BROWSER_FIELD_EDIT_TYPE_CANDIDATES = (
    _JIRA_AA_MAIL_BROWSER_EDIT_CAND_ENV
    if _JIRA_AA_MAIL_BROWSER_EDIT_CAND_ENV
    else list(JIRA_AA_KB_CHATBOT_FIELD_EDIT_TYPE_CANDIDATES)
)
JIRA_AA_MAIL_BROWSER_FIELD_MAIL_BROWSER = (os.getenv("JIRA_AA_MAIL_BROWSER_FIELD_MAIL_BROWSER") or "").strip()
JIRA_AA_MAIL_BROWSER_FIELD_REQUEST_TYPE_SELECT = (
    os.getenv("JIRA_AA_MAIL_BROWSER_FIELD_REQUEST_TYPE_SELECT") or JIRA_AA_KB_CHATBOT_FIELD_REQUEST_TYPE_SELECT
).strip()
JIRA_AA_MAIL_BROWSER_MAIL_OPTION_LABEL = (os.getenv("JIRA_AA_MAIL_BROWSER_MAIL_OPTION_LABEL") or "Нужно").strip()
JIRA_AA_MAIL_BROWSER_REQUEST_TYPE_OPTION_LABEL = (os.getenv("JIRA_AA_MAIL_BROWSER_REQUEST_TYPE_OPTION_LABEL") or "").strip()
JIRA_AA_MAIL_BROWSER_EDIT_OPTION_CREATE = (
    os.getenv("JIRA_AA_MAIL_BROWSER_EDIT_OPTION_CREATE") or JIRA_AA_KB_CHATBOT_EDIT_OPTION_CREATE
).strip()
JIRA_AA_MAIL_BROWSER_EDIT_OPTION_EDIT = (
    os.getenv("JIRA_AA_MAIL_BROWSER_EDIT_OPTION_EDIT") or JIRA_AA_KB_CHATBOT_EDIT_OPTION_EDIT
).strip()

# JSM «Учетная запись для входа на ПК» (AA), см. AA-83385 — поле AA AD Edit type + опциональные текстовые поля
JIRA_AA_PC_ACCOUNT_SERVICE_DESK_ID = (
    os.getenv("JIRA_AA_PC_ACCOUNT_SERVICE_DESK_ID") or JIRA_AA_MAIL_BROWSER_SERVICE_DESK_ID
).strip()
JIRA_AA_PC_ACCOUNT_REQUEST_TYPE_ID = (
    os.getenv("JIRA_AA_PC_ACCOUNT_REQUEST_TYPE_ID") or JIRA_AA_MAIL_BROWSER_REQUEST_TYPE_ID
).strip()
JIRA_AA_PC_ACCOUNT_SUMMARY = (
    os.getenv("JIRA_AA_PC_ACCOUNT_SUMMARY") or "Учетная запись для входа на ПК"
).strip()
JIRA_AA_PC_ACCOUNT_FIELD_FULL_NAME = (
    os.getenv("JIRA_AA_PC_ACCOUNT_FIELD_FULL_NAME") or JIRA_AA_MAIL_BROWSER_FIELD_FULL_NAME
).strip()
JIRA_AA_PC_ACCOUNT_FIELD_POSITION = (
    os.getenv("JIRA_AA_PC_ACCOUNT_FIELD_POSITION") or JIRA_AA_MAIL_BROWSER_FIELD_POSITION
).strip()
JIRA_AA_PC_ACCOUNT_FIELD_AD_EDIT_TYPE_CANDIDATES = _comma_separated_list(
    "JIRA_AA_PC_ACCOUNT_FIELD_AD_EDIT_TYPE_CANDIDATES"
)
JIRA_AA_PC_ACCOUNT_FIELD_COPY_SOURCE = (os.getenv("JIRA_AA_PC_ACCOUNT_FIELD_COPY_SOURCE") or "").strip()
JIRA_AA_PC_ACCOUNT_FIELD_SECURITY_GROUP = (os.getenv("JIRA_AA_PC_ACCOUNT_FIELD_SECURITY_GROUP") or "").strip()
JIRA_AA_PC_ACCOUNT_FIELD_PC_ACCOUNT = (os.getenv("JIRA_AA_PC_ACCOUNT_FIELD_PC_ACCOUNT") or "").strip()
JIRA_AA_PC_ACCOUNT_FIELD_REQUEST_TYPE_SELECT = (
    os.getenv("JIRA_AA_PC_ACCOUNT_FIELD_REQUEST_TYPE_SELECT") or JIRA_AA_MAIL_BROWSER_FIELD_REQUEST_TYPE_SELECT
).strip()
JIRA_AA_PC_ACCOUNT_PC_OPTION_LABEL = (os.getenv("JIRA_AA_PC_ACCOUNT_PC_OPTION_LABEL") or "Нужно").strip()
JIRA_AA_PC_ACCOUNT_REQUEST_TYPE_OPTION_LABEL = (
    os.getenv("JIRA_AA_PC_ACCOUNT_REQUEST_TYPE_OPTION_LABEL") or JIRA_AA_MAIL_BROWSER_REQUEST_TYPE_OPTION_LABEL
).strip()
JIRA_AA_PC_ACCOUNT_ACTION_COPY = (os.getenv("JIRA_AA_PC_ACCOUNT_ACTION_COPY") or "Копировать права").strip()
JIRA_AA_PC_ACCOUNT_ACTION_UNLOCK = (
    os.getenv("JIRA_AA_PC_ACCOUNT_ACTION_UNLOCK") or "Разблокировать учетную запись"
).strip()
JIRA_AA_PC_ACCOUNT_ACTION_GROUP = (
    os.getenv("JIRA_AA_PC_ACCOUNT_ACTION_GROUP") or "Дать доступ к группе безопасности"
).strip()
...
def load_config() -> Dict[str, Any]:
    ...
    config = {
        ...
        "JIRA_AA_KB_CHATBOT": {
            "SERVICE_DESK_ID": JIRA_AA_KB_CHATBOT_SERVICE_DESK_ID,
            "REQUEST_TYPE_ID": JIRA_AA_KB_CHATBOT_REQUEST_TYPE_ID,
            "SUMMARY": JIRA_AA_KB_CHATBOT_SUMMARY,
            "FIELD_FULL_NAME": JIRA_AA_KB_CHATBOT_FIELD_FULL_NAME,
            "FIELD_POSITION": JIRA_AA_KB_CHATBOT_FIELD_POSITION,
            "FIELD_EDIT_TYPE_CANDIDATES": list(JIRA_AA_KB_CHATBOT_FIELD_EDIT_TYPE_CANDIDATES),
            "FIELD_AA_CHATBOT": JIRA_AA_KB_CHATBOT_FIELD_AA_CHATBOT,
            "FIELD_REQUEST_TYPE_SELECT": JIRA_AA_KB_CHATBOT_FIELD_REQUEST_TYPE_SELECT,
            "AA_CHATBOT_OPTION_LABEL": JIRA_AA_KB_CHATBOT_AA_CHATBOT_OPTION_LABEL,
            "REQUEST_TYPE_OPTION_LABEL": JIRA_AA_KB_CHATBOT_REQUEST_TYPE_OPTION_LABEL,
            "EDIT_OPTION_CREATE": JIRA_AA_KB_CHATBOT_EDIT_OPTION_CREATE,
            "EDIT_OPTION_EDIT": JIRA_AA_KB_CHATBOT_EDIT_OPTION_EDIT,
        },
        "JIRA_AA_MAIL_BROWSER": {
            "SERVICE_DESK_ID": JIRA_AA_MAIL_BROWSER_SERVICE_DESK_ID,
            "REQUEST_TYPE_ID": JIRA_AA_MAIL_BROWSER_REQUEST_TYPE_ID,
            "SUMMARY": JIRA_AA_MAIL_BROWSER_SUMMARY,
            "FIELD_FULL_NAME": JIRA_AA_MAIL_BROWSER_FIELD_FULL_NAME,
            "FIELD_POSITION": JIRA_AA_MAIL_BROWSER_FIELD_POSITION,
            "FIELD_EDIT_TYPE_CANDIDATES": list(JIRA_AA_MAIL_BROWSER_FIELD_EDIT_TYPE_CANDIDATES),
            "FIELD_MAIL_BROWSER": JIRA_AA_MAIL_BROWSER_FIELD_MAIL_BROWSER,
            "FIELD_REQUEST_TYPE_SELECT": JIRA_AA_MAIL_BROWSER_FIELD_REQUEST_TYPE_SELECT,
            "MAIL_BROWSER_OPTION_LABEL": JIRA_AA_MAIL_BROWSER_MAIL_OPTION_LABEL,
            "REQUEST_TYPE_OPTION_LABEL": JIRA_AA_MAIL_BROWSER_REQUEST_TYPE_OPTION_LABEL,
            "EDIT_OPTION_CREATE": JIRA_AA_MAIL_BROWSER_EDIT_OPTION_CREATE,
            "EDIT_OPTION_EDIT": JIRA_AA_MAIL_BROWSER_EDIT_OPTION_EDIT,
        },
        "JIRA_AA_PC_ACCOUNT": {
            "SERVICE_DESK_ID": JIRA_AA_PC_ACCOUNT_SERVICE_DESK_ID,
            "REQUEST_TYPE_ID": JIRA_AA_PC_ACCOUNT_REQUEST_TYPE_ID,
            "SUMMARY": JIRA_AA_PC_ACCOUNT_SUMMARY,
            "FIELD_FULL_NAME": JIRA_AA_PC_ACCOUNT_FIELD_FULL_NAME,
            "FIELD_POSITION": JIRA_AA_PC_ACCOUNT_FIELD_POSITION,
            "FIELD_AD_EDIT_TYPE_CANDIDATES": list(JIRA_AA_PC_ACCOUNT_FIELD_AD_EDIT_TYPE_CANDIDATES),
            "FIELD_COPY_SOURCE": JIRA_AA_PC_ACCOUNT_FIELD_COPY_SOURCE,
            "FIELD_SECURITY_GROUP": JIRA_AA_PC_ACCOUNT_FIELD_SECURITY_GROUP,
            "FIELD_PC_ACCOUNT": JIRA_AA_PC_ACCOUNT_FIELD_PC_ACCOUNT,
            "FIELD_REQUEST_TYPE_SELECT": JIRA_AA_PC_ACCOUNT_FIELD_REQUEST_TYPE_SELECT,
            "PC_OPTION_LABEL": JIRA_AA_PC_ACCOUNT_PC_OPTION_LABEL,
            "REQUEST_TYPE_OPTION_LABEL": JIRA_AA_PC_ACCOUNT_REQUEST_TYPE_OPTION_LABEL,
            "ACTION_COPY": JIRA_AA_PC_ACCOUNT_ACTION_COPY,
            "ACTION_UNLOCK": JIRA_AA_PC_ACCOUNT_ACTION_UNLOCK,
            "ACTION_GROUP": JIRA_AA_PC_ACCOUNT_ACTION_GROUP,
        },
        ...
        "JIRA_WMS": {
            ...
            # JSM Request Type «Товары в WAIT» (Issue Type = Поддержка), см. PW-26814
            "REQUEST_TYPE_ID_WAIT_PRODUCTS": (os.getenv("JIRA_WMS_REQUEST_TYPE_ID_WAIT_PRODUCTS") or "1136").strip(),
